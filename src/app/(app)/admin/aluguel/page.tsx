...
export default async function RentalsAdminPage() {
  ...
  return <><header className="page-heading"><span className="eyebrow">Controle interno</span><h1>Patrimônio &amp; Estoque</h1><p>Catálogo de bens, disponibilidade, empréstimos e registro do estado antes da entrega.</p></header><PatrimonyManager initialItems={items} initialRentals={rentals} /></>;
}
